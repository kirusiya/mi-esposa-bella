...
var ImageDialog = {
	...
	insert : function insertImage(ed) {
		...
		var img_align = jQuery('select#image-align').val();
		...
		if(img_align){img_align = 'align="'+img_align+'" ';}else{ img_align = '';}
		 
		var output = '[image '+ img_src + img_height + img_width + img_title + img_class + img_id + img_align +' /]';
